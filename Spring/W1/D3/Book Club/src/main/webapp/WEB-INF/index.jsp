				...
				<form:form action="/register" method="post" modelAttribute="newUser">
					<div class="form-group">
						<div class=" d-flex align-items-center justify-content-between">
							...
							<form:input path="name" class="form-control w-75" />
						</div>
					...
					<div class="form-group ">
						<div class=" d-flex align-items-center justify-content-between">
							<label>Email</label>
							<form:input path="email" class="form-control w-75" />
						</div>
					...
					<div class="form-group">
						<div class=" d-flex align-items-center justify-content-between">
							...
							<form:password path="password" class="form-control w-75" />
						</div>
					...
					<div class="form-group">
						<div class=" d-flex align-items-center justify-content-between">
							...
							<form:password path="confirmPassword" class="form-control w-75" />
						</div>
